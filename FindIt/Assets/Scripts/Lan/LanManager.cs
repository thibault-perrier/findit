...
public class LanManager : MonoBehaviour
{
    ...
    private void GetIPBinaries()
    {
        ...
        for (int i = 0; i < ipBytes.Length; i++)
        {
            ...
            {
                _pIP[index++] = c - '0'; // Convertit le caract�re '0' ou '1' en entier
            }
        }
    }
    private void GetBroadcast()
    {
        ...
        for (int i = 0; i < _broadcast.Length; i += 8)
        {
            ...
            int decimalValue = Convert.ToInt32(octet, 2); // Convertir l'octet binaire en d�cimal
